...
with tab1:
    ...
    # HtmlFile = open("D:/My_Development/Python/streamlit/lesson-1/Streamlit Contents/Peta Leaflet/Kameda, Japan/Rice Yield Prediction (kg-10a)/TopPage.html", 'r', encoding='utf-8')
    # source_code = HtmlFile.read() 
    # components.html(source_code)

    # load map
    rootFolder = os.path.join(os.getcwd(), "01_apps", "xuanthuy")
    riceMapPath = os.path.join(rootFolder, "riceyield-prediction", "XuanThuy_2023.shp")
    ...
    waterDepthPath = os.path.join(rootFolder, "numericalsimulation-max-waterdepth", "XuanThuy_Cells.shp")
...
with tab2:
    ...
    # load map
    kamedaMapPath = os.path.join(rootFolder, "numericalsimulation-max-waterdepth\XuanThuy_Cells.shp")
